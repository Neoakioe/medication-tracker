  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .modal { background: #FDFBF6; border-radius: 14px; width: 480px; max-width: 100%; max-height: 90vh; overflow-y:auto; overflow-x: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.25); border: 1px solid #E4DCC8; }
